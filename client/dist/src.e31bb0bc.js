...
function (_Component) {
  ...
  _createClass(Block, [{
    ...
    value: function render() {
      ...
      var dataDisplay = stringifiedData.length > 15 ? "".concat(stringifiedData.substring(0, 15), "...") : stringifiedData;
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "App"
      }, _react.default.createElement("div", null, "Welcome to the blockchain..."), _react.default.createElement("br", null), _react.default.createElement("div", {
